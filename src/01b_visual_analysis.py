...
class VisualEventClassifier:
    ...
    def classify(self, timestamp: float, ball: BallState | None,
        ...
        # --- TIRO: accelerazione brusca causata da un giocatore ---
        elif (ball.speed > self.t["min_speed_shot"]
              and self.prev_ball is not None
              and self.prev_ball.speed < self.t["min_speed_shot"]  # e' un CALCIO, non moto gia' in volo o un salto isolato
